...
public class AssetManager : MonoBehaviour
{
    ...
    public Texture2D findGameTitleTexture;
    ...
    public Texture2D VolumeLow;
    public Texture2D VolumeMute;
    ...
    {
        audioSource.PlayOneShot(ButtonClickSound, GameState.EffectVolume);
    }
